...
class CustomerControllerTest {
  ...
  void get() throws Exception {
    mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/customer/" + UUID.randomUUID().toString())
  ...
  void create() throws Exception {
    when(customerService.create(isA(Customer.class)))
  ...
  void delete() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders.delete("/api/v1/customer/" + UUID.randomUUID().toString()))
        .andExpect(status().isNoContent());
  }
